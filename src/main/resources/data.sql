...
VALUES (1, '2026-01-02', TRUE, '2026-01-02', NULL, 'Review', 'Initial Owner Investment');
...
MERGE INTO JOURNAL_ENTRY(JOURNAL_ENTRYID, CREATION_DATE, IS_EDITABLE, POST_DATE, POST_SIGNATURE, STATUS, TRANSACTION_DESCRIPTION) 
VALUES (2, '2026-01-10', TRUE, '2026-01-10', NULL, 'Posted', 'Standard Cash Sale');
...
MERGE INTO JOURNAL_ENTRY(JOURNAL_ENTRYID, CREATION_DATE, IS_EDITABLE, POST_DATE, POST_SIGNATURE, STATUS, TRANSACTION_DESCRIPTION) 
VALUES (3, '2026-01-20', TRUE, '2026-01-18', NULL, 'Review', 'Monthly Electricity Bill');
...
MERGE INTO JOURNAL_ENTRY(JOURNAL_ENTRYID, CREATION_DATE, IS_EDITABLE, POST_DATE, POST_SIGNATURE, STATUS, TRANSACTION_DESCRIPTION) 
VALUES (4, '2026-01-25', TRUE, '2026-01-25', NULL, 'Review', 'Inventory Restock');
...
MERGE INTO JOURNAL_ENTRY(JOURNAL_ENTRYID, CREATION_DATE, IS_EDITABLE, POST_DATE, POST_SIGNATURE, STATUS, TRANSACTION_DESCRIPTION) 
VALUES (5, '2026-01-01', TRUE, '2026-01-01', NULL, 'Posted', 'January Office Rent');
...
MERGE INTO JOURNAL_ENTRY(JOURNAL_ENTRYID, CREATION_DATE, IS_EDITABLE, POST_DATE, POST_SIGNATURE, STATUS, TRANSACTION_DESCRIPTION) 
VALUES (6, '2026-01-12', TRUE, '2026-01-12', NULL, 'Posted', 'Customer Payment on Invoice #101');
...
MERGE INTO JOURNAL_ENTRY(JOURNAL_ENTRYID, CREATION_DATE, IS_EDITABLE, POST_DATE, POST_SIGNATURE, STATUS, TRANSACTION_DESCRIPTION) 
VALUES (7, '2026-01-15', TRUE, '2026-01-15', NULL, 'Review', 'Mid-month Payroll');
...
MERGE INTO JOURNAL_ENTRY(JOURNAL_ENTRYID, CREATION_DATE, IS_EDITABLE, POST_DATE, POST_SIGNATURE, STATUS, TRANSACTION_DESCRIPTION) 
VALUES (8, '2026-01-31', TRUE, '2026-01-31', NULL, 'Review', 'Monthly Bank Interest');
